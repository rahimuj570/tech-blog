        ...
        <div class="card">
          <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:200px;">
            ...
            data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"
               ...
               type="button" class="btn btn-outline-dark" data-mdb-ripple-color="dark"
                style="z-index: 1;">
                Edit profile
              </button>
            </div>
            <div class="ms-3" style="margin-top: 50px;">
              <h5><% out.print(u.getUser_name()); %></h5>
              <p>Email: <% out.print(u.getUser_email()); %></p>
              <p>Gender: <% out.print(u.getUser_gender()); %></p>
              <p>Registration Date: <% out.print(u.getRegistration_date()); %></p>
            </div>
          </div>
          ...
          <div class="card-body p-4 text-black">
            <div class="mb-5">
              ...
              <div class="p-4" style="background-color: #f8f9fa;">
                <p class="font-italic mb-1"><% out.print(u.getUser_about()); %></p>
              </div>
            </div>
      ...
      <div class="modal-body">
        <form action="EditUserServlet"  method="post" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input name="dp" required type="file" class="form-control" id="recipient-name">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input namr="email" required type="text" class="form-control" id="recipient-name">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Password:</label>
            <input name="password" required type="password" class="form-control" id="recipient-name">
          </div>
          <div class="mb-3">
